    ...
    <section className="w-full h-full min-h-screen max-h-full">
      ...
      <div className="bg-gray-100 py-10 px-10 flex justify-between items-center max-md:flex-col max-md:gap-3">
        <p className="font-bold text-gray-900 text-xl">
          Sector de presupuestos.
        </p>
        <button
          onClick={() =>
            document.getElementById("my_modal_crear_presupuesto").showModal()
          }
          type="button"
...
export const ModalCrearPresupuesto = ({ setPresupuestos }) => {
  ...
  return (
    <dialog id="my_modal_crear_presupuesto" className="modal">
      <div className="modal-box max-w-full h-full scrollbar-hidden rounded-md  max-md:h-full max-md:w-full max-md:max-h-full max-md:rounded-none">
        ...
        <h3 className="font-bold text-xl">Cargar nuevo presupuesto.</h3>
        <p className="py-0.5 text-sm font-medium">
          En esta ventana podras cargar una nuevo presupuesto, luego comparar
          los precios.
        </p>
