                ...
                <form onSubmit={onSubmit} className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      className="py-2 px-4 uppercase placeholder:text-slate-400 text-slate-700 font-semibold text-sm bg-white border-blue-500 border rounded outline-none w-1/4 max-md:w-auto"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="font-semibold py-2 px-5 uppercase text-sm rounded-xl text-blue-700 flex gap-2 items-center max-md:flex-col max-md:items-start">
                    ...
                    <p className=" font-semibold py-2 px-5 uppercase text-sm rounded-xl text-green-700 flex gap-2 items-center max-md:flex-col max-md:items-start">
